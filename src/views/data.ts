const data = [
    {
        heading: 'Photos',
        desc: 'Returns pictures with names and links',
        routes: [
            {
                route: 'GET /photos/',
    ...
    {
        heading: 'Users',
        desc: 'Returns names, emails and ids',
        routes: [
            {
                route: 'GET /users/',
    ...
    {
        heading: 'Food',
        desc: 'Returns photos of food with picture link, name and taste.',
        routes: [
            {
